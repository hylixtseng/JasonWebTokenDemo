...
namespace JasonWebTokenDemo.Options
{
    public class JwtIssuerOptions
    {
        /// <summary>
        /// "iss" (Issuer) 代表這個 JWT 的簽發者
        /// </summary>
        ...
        /// <summary>
        /// "iat" (Issued At) 代表這個 JWT 的簽發時間(UTC NOW)
        /// </summary>
        ...
        /// 意味著在這個時間之前驗證JWT是會失敗的，預設是 JWT 的簽發時間(UTC NOW)
        /// </summary>
        ...
        /// <summary>
        /// 這是一個時間戳，設定 JWT 在發行後多久會過期
        /// </summary>
        public TimeSpan ValidFor { get; set; } = TimeSpan.FromDays(60);

        /// <summary>
        /// "exp" (Expiration Time) 代表這個 JWT 的過期時間 (return IssuedAt + ValidFor)
        /// </summary>
        ...
        /// <summary>
        /// "jti" (JWT ID) 代表這個 JWT 的唯一識別值，可用來防止 JWT 被重複使用 (default ID is a GUID)
        /// </summary>
